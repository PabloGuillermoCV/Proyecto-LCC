      ...
      try {
         ...
         }
         {
            ...
            dlgAcercaDe.setUndecorated(true);
            {
               ...
               lblAcercaDe1.setText("Ejemplo de conexion a MySQL mediante JDBC");
            ...
            }
            {
               ...
               lblAcercaDe2.setText("Version: 0.2");
               lblAcercaDe2.setHorizontalAlignment(SwingConstants.CENTER);
            }
            {
               lblAcercaDe3 = new JLabel();
               lblAcercaDe3.setText("<html><center>Bases de Datos<br/>Elementos de Bases de Datos<br/>Teoria y Diseno de Bases de Datos<br/>");
            ...
            }
            {
               ...
               lblAcercaDe4.setText("<html><center>Dpto. de Ciencias e Ingenieria de la Computacion<br/>Universidad Nacional del Sur");
         ...
         }
         {
            ...
            setJMenuBar(jMenuBar1);
            {
               ...
               mnuEjemplos.setText("Ejemplos");
               {
                  ...
                  mniBarcos.setText("Busqueda de Barcos (Utilizando JTable)");
