...
public class VentanaConsultas extends javax.swing.JInternalFrame {
   ...
   private void conectarBD()
   {
         try
         {
            ...
            //establece una conexion con la  B.D. "batallas"  usando directamante una tabla DBTable    
   ...
   private void refrescarTabla()
   {
      ...
      {    
    	  ...
    	  // patir de la conexion y la consulta seteadas con connectDatabase() y setSelectSql() respectivamente.
