...
public class VentanaBarcos extends javax.swing.JInternalFrame {
   ...
   private void initGUI() {
      try {
         ...
         this.setTitle("Busqueda de Barcos (Utilizando JTable)");
